...
def REPO_SLUG = 'nangman-infra/heejun-home'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/heejun-home.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'heejun-home main push detected',
                ...
                stage('SonarQube Analysis') {
                    steps {
                        script {
                            ...
                            def candidates = ['app', 'src', 'components', 'content', 'data', 'domains', 'lib', 'pages']
                            ...
                            writeFile(
                                ...
                                text: """
                                    ...
                                    sonar.coverage.exclusions=**/*.test.ts,**/*.test.tsx,**/vitest.setup.ts,app/layout.tsx
